...
def tuning_mlp(X, y, rs=10, cvn=5, r2='r2',  njobs=-1):
	X = X
	y = y
	param_test = {'hidden_layer_sizes':[10, 50, 100], 'activation':['relu']}
...
def tuning_svr(X, y, rs=10, cvn=5, r2='r2', njobs=-1):
	X = X
	y = y
	param_test = [{'kernel': ['rbf'], 'gamma': ['scale', 'auto'], 'C': [0.1, 1.0, 10]},{'kernel': ['linear'], 'C': [0.1, 1.0, 10]}]
...
def tuning_rf(X, y, rs=10, cvn=5, r2='r2', njobs=-1):
	...
	param_test2 = {'max_depth':[None,5,10], 'min_samples_split':[2,3]}
	param_test3 = {'min_samples_leaf':[1,2]}
...
def tuning_gb(X, y, rs=10, cvn=5, r2='r2', njobs=-1):
	...
	#parameters tests
	param_test1 = {'n_estimators':[50,100,200,500]}
	param_test2 = {'max_depth':[3,5,10], 'min_samples_split':[1,2,3]}
	param_test3 = {'min_samples_leaf':[1,2]}
	param_test5= {'subsample':[0.8,1.0]}
	param_test6a= {'learning_rate':[0.05]}
...
def tuning_lgb(X, y, rs=10, cvn=5, r2='r2', njobs=1):
	...
	#parameters tests
	param_test1 = {'n_estimators':[50,100,200,500]}
	param_test2 = {'max_depth':[-1,5,10], 'num_leaves':[26,31,36]}
	param_test3 = {'min_child_samples': [15, 20, 25], 'min_child_weight':[0.001]}
